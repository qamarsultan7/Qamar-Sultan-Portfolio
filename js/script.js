...
const filterFunc = function (selectedValue) {
  ...
  // Use the function from projects.js to check if we need to show the message
  if (typeof window.checkVisibleProjects === 'function') {
    window.checkVisibleProjects();
  }
}
...
document.addEventListener("DOMContentLoaded", function() {
  // Set a small timeout to ensure all other DOM operations are complete
  setTimeout(() => {
    if (typeof window.checkVisibleProjects === 'function') {
      window.checkVisibleProjects();
    }
